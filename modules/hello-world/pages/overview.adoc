...
The Columnar Java SDK allows you to connect to a Capella Columnar cluster from Java.
For connecting to a Couchbase Server Cluster -- self-managed, or Capella Operational --
see our xref:java-sdk:hello-world:overview.adoc[Java Server SDK].
...
How-to guides and tutorials to help you start your development journey with Columnar and the Java SDK.
...
[.column]
.Deployment Docs
* xref:project-docs:columnar-sdk-release-notes.adoc[]
