...
See the link:++https://docs.couchbase.com/sdk-api/couchbase-columnar-java-client/com.couchbase.columnar.client.java/com/couchbase/columnar/client/java/Cluster.html#executeStreamingQuery(java.lang.String,java.util.function.Consumer,java.util.function.Consumer)++[API reference] for more details.
